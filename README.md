...
Annotation and inspection tool designed to create structured labels for biometrics datasets (focused on consistency and quality control).

<i>Built to reduce label noise and keep biometric annotations consistent across datasets.</i>

**Key Features**
- Multi-label error classification
- Structured exports ready for ML training
- Quality control workflow for reliable datasets
...
Image processing utilities focused on alignment and normalization, built to support repeatable experiments and standardized outputs.

<i>Preprocessing utilities to standardize alignment and normalization so experiments stay repeatable.</i>

**Key Features**
- Automatic alignment (translation/rotation)
- Batch processing for faster pipelines
- Standardized output format for downstream steps
...
Desktop application focused on UI/UX and mathematical visualization, built as a practical project to explore interactive interfaces.

<i>A desktop playground for interactive math visualization and UI experiments.</i>

**Key Features**
- Mathematical function rendering
- Interactive and responsive UI
- Scientific/advanced operations support

<img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white" alt="Python" />
<img src="https://img.shields.io/badge/Tkinter-FFD43B?style=flat-square&logo=python&logoColor=blue" alt="Tkinter" />

</td>
<td width="50%" valign="top">

### [BenaSPMA](https://github.com/Mathsto19/BenaSPMA)

Web system for scheduling and appointment management, designed around a clean workflow and a responsive interface.

<i>A scheduling workflow designed to be simple for users and practical to manage.</i>
